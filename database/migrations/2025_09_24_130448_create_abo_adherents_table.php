...
class CreateAboAdherentsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('abo_adherents', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('abo_adherents');
    }
}
